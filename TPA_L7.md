Sa se declare si initializeze un vector:

```java
int[] v = {50, 0, 21, 19, 15};
```

a) Sa se acceseze primul si ultimul element din vector si sa se afiseze aceste valori in consola.

b) Sa se modifice al treilea element din vector, setandu-l la valoarea 100.

c) Sa se afle lungimea vectorului si sa se afiseze aceasta valoare.

d) Sa se copieze continutul vectorului intr-un alt vector. [Citeste mai multe aici](https://docs.oracle.com/javase/8/docs/api/java/util/Arrays.html#copyOf-int:A-int-)
